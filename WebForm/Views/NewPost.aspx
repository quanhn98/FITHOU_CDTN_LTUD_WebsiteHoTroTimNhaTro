<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewPost.aspx.cs" Inherits="WebForm.Views.Public.NewPost" EnableEventValidation="false"%>
                ...
                <div style="flex-grow: 1; flex-basis: auto; padding: 10px; width: 50%">
                    ...
                    <div style="display: flex">
                        <div style="flex-grow: 1; flex-basis: 0; padding-right: 15px; width: 50%">
                            <h4>Giá</h4>
                            <div>
                                <asp:TextBox ID="tbPrice" runat="server" CssClass="form-control price" ToolTip=""></asp:TextBox>
                                Triệu 
                                <asp:RequiredFieldValidator
                        ...
                        <div style="flex-grow: 1; flex-basis: 0; padding-left: 15px">
                            <h4>Diện tích</h4>
                            <div>
                                <asp:TextBox ID="tbAcreage" runat="server" CssClass="form-control price" TextMode="Number" ToolTip="Đơn vị m2"></asp:TextBox>
                                m2
                                <asp:RequiredFieldValidator
                                    ID="RequiredFieldValidator1"
                                    ControlToValidate="tbAcreage"
